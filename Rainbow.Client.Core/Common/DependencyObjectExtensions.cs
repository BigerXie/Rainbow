...
namespace Rainbow.UI.Core.Common
{
	public static class DependencyObjectExtensions
	{
		...
		/// <returns></returns>
		public static IList<T> GetVisualChildCollection<T>(this DependencyObject parent) where T : DependencyObject
		{
		...
		private static void GetVisualChildCollection<T>(DependencyObject parent, IList<T> visualCollection)
